...
try:
    # Create Gemini client using your API key from Streamlit Secrets
    ...
    if user_question:
        ...
        current_features = st.session_state.get('features', [])

        context = f"""
You are a Senior Data Scientist.

The user has trained a machine learning model.

Target Column: {current_target}

Current Model Accuracy: {current_acc}

Features Used:
{current_features}

Answer the user's question clearly, professionally, and in simple language.
"""
